    ...
    if (indexPath.section == 1 && indexPath.row == 2) {
        ...
        if (cell == nil) {
            ...
            [cell.contentView addSubview:datePicker];
                ...
                NSDate *minDate = [gregorianCalendar dateByAddingComponents:comps toDate:currentDate  options:0];
                [comps setYear:+30];
                NSDate *maxDate = [gregorianCalendar dateByAddingComponents:comps toDate:currentDate  options:0];
